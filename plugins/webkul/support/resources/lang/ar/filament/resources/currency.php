...
return [
    ...
    'table' => [
        ...
        'actions' => [
            ...
            'deactivate' => [
                'notification' => [
                    'title' => 'لا يمكن إلغاء تفعيل العملة',
                    'body'  => 'هذه العملة مستخدمة من قبل شركة واحدة أو أكثر ولا يمكن إلغاء تفعيلها.',
                ],
            ],
        ],
        ...
        'bulk-actions' => [
            'delete' => [
                'notification' => [
                    ...
                    'error' => [
                        'title' => 'تعذر حذف العملات',
                        'body'  => 'بعض العملات المحددة قيد الاستخدام ولا يمكن حذفها.',
                    ],
                ],
            ],
        ],
